...
public class Inventario
{
     ...
     *         {
     *             System.out.println(inventario_items[i].getNombre() + ": " + inventario_items[i].getHP());
     *         }
     *     }
     *      else
     *      {
     ...
     *         {
     *             System.out.println(inventario_armas[i].getNombre() + ": " + inventario_armas[i].getHP());
     *         }
     *      }
     *}
     */
     ...
     *     {
     *         cuantosArmas++;
     *        inventario_items[cuantosArmas] = objeto;
     *      }
     * }
     */
